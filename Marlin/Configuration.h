...
#define CUSTOM_MACHINE_NAME "roby's printer"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "26a5eaed-7ce5-439b-96d0-657c37760199"
...
#define DELTA
  ...
  #define DELTA_RADIUS 135.4 //mm  Get this value from auto calibrate
 ...
 *
 */
#define Z_MIN_PROBE_ENDSTOP Z_MIN_PIN
...
#define MANUAL_Z_HOME_POS 325 // Distance between the nozzle to printbed after homing
